...
class TestHwidInfo:
    ...
    async def test_get_hwid_user(self, remnawave):
        ...
        hwid = await remnawave.hwid.get_hwid_user(user_id=int(REMNAWAVE_USER_ID))
...
class TestHwidCRUD:
    ...
    async def test_add_hwid_to_user(self, remnawave, test_hwid):
        ...
        hwid_check = await remnawave.hwid.get_hwid_user(user_id=int(REMNAWAVE_USER_ID))
    ...
    async def test_delete_all_hwid_user(self, remnawave):
        ...
        check_before = await remnawave.hwid.get_hwid_user(user_id=int(REMNAWAVE_USER_ID))
